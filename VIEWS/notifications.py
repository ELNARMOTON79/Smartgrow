...
class Notifications:
    def __init__(self, parent):
        ...
        # Header
        ctk.CTkLabel(
            self.frame, text="🔔 Notifications", font=ctk.CTkFont(size=22, weight="bold"),
        ...
        notificaciones = [
            {"titulo": "Update available", "message": "There is a new version of the system."},
            {"titulo": "Reminder", "message": "Don't forget to check the configuration module."},
            {"titulo": "Alert", "message": "An unusual change in data has been detected."}
        ]
        
        for notif in notificaciones:
            card = self._create_notification_card(scrollable, notif["titulo"], notif["message"])
